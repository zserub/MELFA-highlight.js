...
},contains:[{className:"comment",begin:"'.*"},{className:"meta",begin:"^\\d+"},{
className:"number",begin:"-?&O[0-7]+",relevance:0,illegal:"\\S"},{
...
relevance:0,illegal:"\\S"},{className:"keyword",
begin:"!|\\$|%|&|\\-|\\+|~|==|=|!=|!==|<=|>=|#=|<>|<|>|!|&&|\\|\\||\\?\\:|\\*=|/=|%=|\\+=|\\-=|&=|\\^=\\b"
},{className:"string",begin:'"',end:'"'},{className:"type",begin:"\\B\\*\\w+"},{
className:"function",begin:"\\b(Call|Function|Def)\\b",case_insensitive:!0},{
className:"function",
...
case_insensitive:!0},{className:"variable",begin:"\\b(\\.X|\\.Y|\\.Z)\\b",
