/*! `melfa` grammar compiled for Highlight.js 11.9.0 */
var hljsGrammar=(()=>{"use strict";return e=>({name:"MELFA",keywords:{
...
},contains:[{className:"comment",begin:"'.*"},{className:"linenumber",
begin:"^\\d+"},{className:"number",begin:"-?&O[0-7]+",relevance:0,illegal:"\\S"
},{className:"number",begin:"-?&H[0-9A-F]+",relevance:0,illegal:"\\S"},{
className:"number",begin:"-?\\d+(\\.\\d+)?",relevance:0,illegal:"\\S"},{
className:"control",
...
relevance:0,illegal:"\\S"},{className:"operator",
begin:"!|\\$|%|&|\\-|\\+|~|==|=|!=|!==|<=|>=|#=|<>|<|>|!|&&|\\|\\||\\?\\:|\\*=|/=|%=|\\+=|\\-=|&=|\\^=\\b"
},{className:"other",
begin:"\\b(Exit|Go(To|Sub)|Dly|Wait|Error|Priority|ResetErr|Stop|Hlt|Clear|Skip|X(Load|Run|Rst|Clr|Stp))\\b",
case_insensitive:!0},{className:"string",begin:'"',end:'"'},{className:"type",
begin:"\\B\\*\\w+"},{className:"keyword_bold",
begin:"\\b(Call|Function|Def|On|Off)\\b",case_insensitive:!0},{
className:"function",
begin:"((\\b[a-zA-Z_x7f-xff][a-zA-Z0-9_x7f-xff]*?\\b)(?=\\(\\)?))"},{
className:"type",begin:"\\b(Pos|Jnt|Inte|Float)\\b",case_insensitive:!0},{
className:"function",
...
case_insensitive:!0},{className:"variable",begin:"\\b(M_\\w+|J_\\w+|P_\\w+)\\b",
case_insensitive:!0},{className:"axis",begin:"\\b(\\.X|\\.Y|\\.Z)\\b",
case_insensitive:!0}]})})();export default hljsGrammar;